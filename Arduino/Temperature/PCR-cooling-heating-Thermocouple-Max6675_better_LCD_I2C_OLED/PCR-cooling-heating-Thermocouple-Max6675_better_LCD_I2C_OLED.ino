...
//  u8g2.clearBuffer();          // clear the internal memory
  ...
  u8g2.drawStr(1,8,"Temp:");  // write something to the internal memory
  u8g2.setCursor(33,10); // set cursor position lcd
 
  u8g2.print(temp.readCelsius());
  
//  u8g2.setCursor(1,30); // set cursor position lcd
//  u8g2.sendBuffer();          // transfer internal memory to the display
 
  u8g2.setFont(u8g2_font_6x10_tf);
//  u8g2.drawGlyph(55, 15, 0x2603);  /* dec 9731/hex 2603 Snowman */
//  u8g2.sendBuffer();          // transfer internal memory to the display
//  u8g2.setFont(u8g2_font_sirclivethebold_tr); // choose a suitable font
  u8g2.drawStr(1,19,"L_Temp:");  // write something to the internal memory
  u8g2.setCursor(55,19); // set cursor position lcd
//  u8g2.drawStr(1,50,"dsada:");  // write something to the internal memory
  u8g2.print(lowtemp);

  u8g2.drawStr(1,30,"H_Temp:");  // write something to the internal memory
  u8g2.setCursor(55,30); // set cursor position lcd
//  u8g2.drawStr(1,50,"dsada:");  // write something to the internal memory
  u8g2.print(hightemp);
...
//  lcd.print("F");
  ...
  lcd.print("Miss");}  
    ...
    lcd.print("On");
    u8g2.drawStr(66,8,"|  Relay: On");  // write something to the internal memory
    u8g2.sendBuffer();
    ...
    lcd.print("Off");
    u8g2.drawStr(66,8,"|  Relay: Off");  // write something to the internal memory
    u8g2.sendBuffer();
    t=0;}
   u8g2.clearBuffer();
//   delay(500);
